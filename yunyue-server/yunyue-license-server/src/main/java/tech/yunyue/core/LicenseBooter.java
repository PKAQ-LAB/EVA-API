package tech.yunyue.core;

import tech.yunyue.core.license.LicenseGenerator;
import tech.yunyue.core.license.LicenseVerify;
...
@ComponentScan(basePackages = {"tech.yunyue.*"})

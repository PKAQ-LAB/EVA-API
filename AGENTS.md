...
This project is indexed by GitNexus as **EVA-API** (3329 symbols, 7194 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

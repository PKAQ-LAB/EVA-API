...
public class WebUtil extends WebUtils {
    ...
    public static String getIP(HttpServletRequest request) {
        ...
        if (StrUtils.isBlank(ip) || UN_KNOWN.equalsIgnoreCase(ip)) {
        ...
        return StrUtils.isBlank(ip) ? null : ip.split(",")[0];
    }
    ...
    public static String getRequestStr(HttpServletRequest request, byte[] buffer) throws IOException {
        ...
        if (StrUtils.isBlank(str)) {
            ...
            while (parameterNames.hasMoreElements()) {
                ...
                sb = StrUtils.join(true, key, "=", value, "&");
            }
            str = StrUtils.removeEnd(sb, "&");
        }
    ...
    public static String getRequestContent(HttpServletRequest request) {
        try {
            ...
            if (StrUtils.isBlank(str)) {
                ...
                str = StrUtils.removeEnd(sb.toString(), "&");
            }
            return str.replaceAll("&amp;", "&");
        } catch (Exception ex) {
            ex.printStackTrace();

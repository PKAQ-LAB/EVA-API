...
public class CommonResponseAdvice implements ResponseBodyAdvice {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        response.getHeaders().set("version", StrUtil.isNotEmpty(version) ? version : "unknown");
...
//
            ...
            if (!Objects.equals(Ctrl.class, Objects.requireNonNull(returnType.getMethod()).getDeclaringClass().getSuperclass())) {
                return body;
            }

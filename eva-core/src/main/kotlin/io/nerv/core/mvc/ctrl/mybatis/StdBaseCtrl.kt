 ...
 */
@Getter
abstract class StdBaseCtrl<T : StdBaseService<*, *>?, E : StdBaseEntity?> {
    @JvmField
    @Autowired
    ...
    @NoRepeatSubmit
    fun listAll(@ApiParam(name = "condition", value = "模型对象") entity: E, pageNo: Int?, pageSize: Int?): Response? {
        return this.success(service!!.list(entity))
    }

...
public class ResAuthenticationEntryPoint implements ServerAuthenticationEntryPoint {
    ...
    public Mono<Void> commence(ServerWebExchange exchange, AuthenticationException e) {
		...
		message.set("code", HttpStatus.UNAUTHORIZED.value());
		message.set("msg",  e.getMessage());
        ...
        DataBuffer buffer = dataBufferFactory.wrap(message.toJSONString(4).getBytes(Charset.defaultCharset()));

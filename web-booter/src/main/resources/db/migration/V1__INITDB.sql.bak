...
(
    ...
    `status`     varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0000',
    PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
VALUES ('1', 'biz', '业务代码', '0', '业务代码', '1899-12-31 08:00:00', '1899-12-31 08:00:00', NULL, '', '9999');
INSERT INTO `sys_dict`
VALUES ('1174974634025496578', 'data_permission', '数据权限', '1', '数据权限类型', '2019-09-20 17:12:37',
        '2019-09-20 19:41:56', NULL, NULL, '9999');
INSERT INTO `sys_dict`
VALUES ('3', 'sys', '系统代码', '0', '系统代码', '1899-12-31 08:00:00', '1899-12-31 08:00:00', NULL, NULL, '9999');
INSERT INTO sys_dict (id, code, name, parent_id, create_by, gmt_create, modify_by, gmt_modify)
VALUES ('1247707145754607618', 'unit', '单位', '1', '9199482d76b443ef9f13fefddcf0046c', null,
        '9199482d76b443ef9f13fefddcf0046c', null);
INSERT INTO sys_dict (id, code, name, parent_id, create_by, gmt_create, modify_by, gmt_modify)
VALUES ('1247704849712906241', 'dict_type', '所属分类', '3', '9199482d76b443ef9f13fefddcf0046c',
        '2020-04-08T09:56:32.070004400', '9199482d76b443ef9f13fefddcf0046c', '2020-04-08T09:56:32.070004400');
...
VALUES ('1174974634100994050', '1174974634025496578', '0000', '全部', 0);
INSERT INTO `sys_dict_item`
VALUES ('1174974634117771265', '1174974634025496578', '0001', '仅本部门', 1);
INSERT INTO `sys_dict_item`
VALUES ('1174974634142937089', '1174974634025496578', '0002', '本部门及下属部门', 2);
INSERT INTO `sys_dict_item`
VALUES ('1174974634159714305', '1174974634025496578', '0003', '指定部门', 3);
INSERT INTO `sys_dict_item`
VALUES ('1174974634176491521', '1174974634025496578', '0005', '仅本人创建', 5);
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('5ee97d5c83464aeaa08dc441c396f62b', '1247704849712906241', '3', '系统代码');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('f6fb18fd71c665baf57e680bc5a28fec', '1247704849712906241', '1', '业务代码');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('5e800ffc87bd97f11253931d03dd00a9', '1247707145754607618', '0001', 'kg');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('147be54e535f46917fa4d90c3ffba614', '1247707145754607618', '0002', 'g');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('708ae86549fbe78b483f7fd1ab28cd6c', '1247707145754607618', '0003', '桶');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811506', '1247707145754607618', '0004', '袋');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811517', '1247707145754607618', '0005', '件');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811518', '1247707145754607618', '0006', '个');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811519', '1247707145754607618', '0007', '箱');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811520', '1247707145754607618', '0008', '瓶');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811521', '1247707145754607618', '0009', 'm³');
INSERT INTO sys_dict_item (id, main_id, key_name, key_value)
VALUES ('60ed545f6803b47e161e67959a811522', '1247707145754607618', '0010', '平方');
...
(
    ...
    `orders`      int(11) NULL DEFAULT NULL COMMENT '排序',
    `status`      varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0000' COMMENT '状态',
    `remark`      varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `gmt_create`  datetime(0) NULL DEFAULT NULL,
    `gmt_modify`  datetime(0) NULL DEFAULT NULL,
    `create_by`   varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
VALUES ('10', '字典管理', 'profile', NULL, NULL, '5,5', '5', NULL, '/sys/dictionary', NULL, 1, 4, '9999', NULL, NULL,
        '2019-11-01 10:36:40', NULL, '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('1186192719776305153', '系统监控', 'radar-chart', NULL, NULL, NULL, NULL, NULL, '/monitor', NULL, 1, 5, '9999',
        NULL, '2019-10-21 16:09:17', '2019-10-21 16:09:17', '9199482d76b443ef9f13fefddcf0046c',
        '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('1186192847761297410', '业务日志', 'file', NULL, NULL, '1186192719776305153', '1186192719776305153', '系统监控',
        '/monitor/log/biz', '系统监控/业务日志', 1, 1, '9999', NULL, '2019-10-21 16:09:48', '2019-10-21 16:11:02',
        '9199482d76b443ef9f13fefddcf0046c', '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('1186192979059789826', '异常日志', 'file', NULL, NULL, '1186192719776305153', '1186192719776305153', '系统监控',
        '/monitor/log/error', '系统监控/异常日志', 1, 2, '9999', NULL, '2019-10-21 16:10:19', '2019-10-21 16:11:08',
        '9199482d76b443ef9f13fefddcf0046c', '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('1187588287316574209', '代码生成', 'rocket', NULL, NULL, NULL, NULL, NULL, '/dev/generator', NULL, 1, 6, '9999',
        NULL, '2019-10-25 12:34:47', '2019-10-25 12:34:47', '9199482d76b443ef9f13fefddcf0046c',
        '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('1187919802302926850', '进销存', 'home', NULL, NULL, NULL, NULL, NULL, '/pdos', NULL, 1, 7, '9999', NULL,
        '2019-10-26 10:32:06', '2019-10-26 10:32:06', '9199482d76b443ef9f13fefddcf0046c',
        '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('5', '系统管理', 'setting', NULL, NULL, '5', NULL, '系统管理', '/sys', NULL, 0, 0, '9999', NULL, NULL,
        '2019-10-15 12:41:52', NULL, NULL);
INSERT INTO `sys_module`
VALUES ('6', '组织管理', 'flag', NULL, NULL, '5,5', '5', NULL, '/sys/organization', NULL, 1, 0, '9999', NULL, NULL,
        '2019-11-01 10:36:52', NULL, '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('7', '模块管理', 'bars', NULL, NULL, '5,5', '5', NULL, '/sys/module', NULL, 1, 3, '9999', NULL, NULL,
        '2019-11-01 10:36:56', NULL, '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('8', '用户管理', 'usergroup-add', NULL, NULL, '5,5', '5', NULL, '/sys/account', NULL, 1, 1, '9999', NULL, NULL,
        '2019-11-01 10:36:55', NULL, '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_module`
VALUES ('9', '权限管理', 'form', NULL, NULL, '5,5', '5', NULL, '/sys/role', NULL, 1, 2, '9999', NULL, NULL,
        '2019-11-01 10:36:56', NULL, '9199482d76b443ef9f13fefddcf0046c');
...
VALUES ('10', '10', '全部资源', '**', '');
INSERT INTO `sys_module_resources`
VALUES ('1186193037775851522', '1186192979059789826', '全部资源', '/**', '9999');
INSERT INTO `sys_module_resources`
VALUES ('1186193072919924737', '1186192847761297410', '全部资源', '/**', '9999');
INSERT INTO `sys_module_resources`
VALUES ('1187931885706899458', '1187931885673345025', '全部资源', '/**', '9999');
INSERT INTO `sys_module_resources`
VALUES ('1187931978862391298', '1187931978845614082', '全部资源', '/**', '9999');
INSERT INTO `sys_module_resources`
VALUES ('1187934072734441473', '1187934072596029442', '全部资源', '/**', '9999');
...
(
    ...
    `status`      varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0001' COMMENT '逻辑删除',
    `remark`      varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `gmt_create`  datetime(0) NULL DEFAULT NULL,
    `gmt_modify`  datetime(0) NULL DEFAULT NULL,
    `create_by`   varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
VALUES ('1', '统合部', 'THB', '0', NULL, '1', '统合部', 1, 1, '9999', NULL, NULL, NULL, NULL, NULL, '0000');
INSERT INTO `sys_organization`
VALUES ('12', '卡拉吉塔集团', 'GKL', '6', '加达里', '6/12', '加达里/卡拉吉塔集团', 0, 1, '0000', NULL, NULL, NULL, NULL,
        NULL, '0000');
INSERT INTO `sys_organization`
VALUES ('13', '应用知识学院', 'GKN', '6', '加达里', '6/13', '加达里/应用知识学院', 0, 4, '0000', NULL, NULL, NULL, NULL,
        NULL, '0000');
INSERT INTO `sys_organization`
VALUES ('2', '协约理事会', 'LSH', '1', '统合部', '1/2', '统合部/协约理事会', 0, 3, '9999', NULL, NULL, NULL, NULL, NULL,
        '0000');
INSERT INTO `sys_organization`
VALUES ('3', '联合安全局', 'DED', '1', '统合部', '1/3', '统合部/联合安全局', 0, 1, '9999', NULL, NULL, NULL, NULL, NULL,
        '0000');
INSERT INTO `sys_organization`
VALUES ('4', '商业安全委员会', 'CAD', '1', '统合部', '1/4', '统合部/商业安全委员会', 0, 0, '9999', NULL, NULL, NULL,
        NULL, NULL, '0000');
INSERT INTO `sys_organization`
VALUES ('5', '统合关系司令部', 'SLB', '1', '统合部', '1/5', '统合部/统合关系司令部', 0, 2, '9999', NULL, NULL, NULL,
        NULL, NULL, '0000');
INSERT INTO `sys_organization`
VALUES ('6', '加达里', 'GDRR', '0', NULL, '6', '加达里', 0, 0, '0000', NULL, NULL, '2019-10-28 20:24:22', NULL,
        '9199482d76b443ef9f13fefddcf0046c', '0000');
INSERT INTO `sys_organization`
VALUES ('7', '三岛集团', 'SD', '6', '加达里', '6/7', '加达里/三岛集团', 0, 0, '0000', NULL, NULL, NULL, NULL, NULL,
        '0000');
...
VALUES ('1', '系统管理员', 'ROLE_ADMIN', NULL, NULL, NULL, NULL, NULL, NULL, '9999', NULL, NULL, NULL, NULL, NULL,
        '0000', NULL);
INSERT INTO `sys_role`
VALUES ('1191916813788344321', '系统操作员', 'ROLE_OPERATOR', NULL, NULL, NULL, NULL, NULL, NULL, '0000',
        '系统操作员 仅可操作本人所属部门及下级部门数据', '2019-11-06 11:14:48', '2019-11-06 14:36:19',
        '9199482d76b443ef9f13fefddcf0046c', '9199482d76b443ef9f13fefddcf0046c', '0002', NULL);
...
VALUES ('11', '2', '11', NULL);
INSERT INTO `sys_role_module`
VALUES ('1187937381595709441', '1', '1186192979059789826', '1186193037775851522');
INSERT INTO `sys_role_module`
VALUES ('1187937381608292353', '1', '6', '6');
INSERT INTO `sys_role_module`
VALUES ('1187937381625069569', '1', '7', '7');
INSERT INTO `sys_role_module`
VALUES ('1187937381637652481', '1', '8', '8');
INSERT INTO `sys_role_module`
VALUES ('1187937381654429697', '1', '1186192719776305153', NULL);
INSERT INTO `sys_role_module`
VALUES ('1187937381671206913', '1', '1187588287316574209', NULL);
INSERT INTO `sys_role_module`
VALUES ('1187937381687984129', '1', '9', '9');
INSERT INTO `sys_role_module`
VALUES ('1187937381704761346', '1', '1187919802302926850', NULL);
INSERT INTO `sys_role_module`
VALUES ('1187937381721538562', '1', '1186192847761297410', '1186193072919924737');
INSERT INTO `sys_role_module`
VALUES ('1187937381738315777', '1', '10', '10');
INSERT INTO `sys_role_module`
VALUES ('1187937381750898690', '1', '5', NULL);

INSERT INTO `sys_role_module`
VALUES ('1191921989085532161', '1191916813788344321', '1186192979059789826', '1186193037775851522');
INSERT INTO `sys_role_module`
VALUES ('1191921989106503681', '1191916813788344321', '6', '6');
INSERT INTO `sys_role_module`
VALUES ('1191921989114892289', '1191916813788344321', '7', '7');
INSERT INTO `sys_role_module`
VALUES ('1191921989131669506', '1191916813788344321', '8', '8');
INSERT INTO `sys_role_module`
VALUES ('1191921989148446722', '1191916813788344321', '1186192719776305153', NULL);
INSERT INTO `sys_role_module`
VALUES ('1191921989156835329', '1191916813788344321', '9', '9');
INSERT INTO `sys_role_module`
VALUES ('1191921989173612546', '1191916813788344321', '1186192847761297410', '1186193072919924737');
INSERT INTO `sys_role_module`
VALUES ('1191921989182001154', '1191916813788344321', '10', '10');
INSERT INTO `sys_role_module`
VALUES ('1191921989198778370', '1191916813788344321', '5', NULL);
...
VALUES ('1183314144530264065', '1', '9199482d76b443ef9f13fefddcf0046c');
INSERT INTO `sys_role_user`
VALUES ('1184376663802040322', '1', '1173117564929937409');
INSERT INTO `sys_role_user`
VALUES ('1184377281077760002', '1', '1184377281048399874');
INSERT INTO `sys_role_user`
VALUES ('1184382031080902658', '1', '1184382031034765313');
INSERT INTO `sys_role_user`
VALUES ('1184390438361739266', '1', '1184390438344962049');
INSERT INTO `sys_role_user`
VALUES ('1192011503128739842', '1191916813788344321', '1190104332380127233');
...
(
    ...
    `locked`       varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0000',
    `gmt_create`   datetime(0) NULL DEFAULT NULL,
    `gmt_modify`   datetime(0) NULL DEFAULT NULL,
    `create_by`    varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
    `modify_by`    varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
VALUES ('1190104332380127233', NULL, 'scott', '{bcrypt}$2a$10$hxJDzKrEBPaYfpYne/.07OEjoK8s5vYv9HpC6Si73UzFj6Pg5om/6',
        NULL, '', '操作员', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000', '2019-11-01 11:12:39',
        '2019-11-06 17:31:04', '9199482d76b443ef9f13fefddcf0046c', '9199482d76b443ef9f13fefddcf0046c', '6', '加达里',
        NULL, '0000', '');
INSERT INTO `sys_user_info`
VALUES ('9199482d76b443ef9f13fefddcf0046c', 'admin', 'admin',
        '{bcrypt}$2a$10$Nv1jaTk1xeCA7Mmzn9jcBeaOP5DjW5X9DW.9bu02Hs6/cOdbyMIF.', 'i4z62k6qcaxspaqa', '', '超级管理员',
        NULL, 'pkaq@msn.com', '133', NULL, NULL, NULL, NULL, '9999', NULL, '2019-10-09 20:20:04', NULL, NULL, '1',
        '统合部', 'AAACCC', '0000', '');
...
CREATE
ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `v_dict` AS
select `a`.`code`      AS `code`,
       `a`.`name`      AS `name`,
       `b`.`key_name`  AS `key_name`,
       `b`.`key_value` AS `key_value`,
       `b`.`orders`    AS `orders`
from (`sys_dict` `a` join `sys_dict_item` `b` on (((`a`.`ID` = `b`.`MAIN_ID`) and (`a`.`status` <> '0000'))))
where ((`a`.`status` <> '0000') and (`a`.`PARENT_ID` <> '0') and (`a`.`PARENT_ID` is not null))
order by `a`.`code`, `b`.`orders`;
...
CREATE
ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `v_granted_module` AS
select `m`.`ID`          AS `ID`,
       `m`.`name`        AS `name`,
       `m`.`icon`        AS `icon`,
       `m`.`routeUrl`    AS `routeUrl`,
       `m`.`modelUrl`    AS `modelUrl`,
       `m`.`PATH_ID`     AS `PATH_ID`,
       `m`.`PARENT_ID`   AS `PARENT_ID`,
       `m`.`PARENT_NAME` AS `PARENT_NAME`,
       `m`.`path`        AS `path`,
       `m`.`PATH_NAME`   AS `PATH_NAME`,
       `m`.`isleaf`      AS `isleaf`,
       `m`.`orders`      AS `orders`,
       `m`.`status`      AS `status`,
       `m`.`remark`      AS `remark`,
       `m`.`gmt_create`  AS `gmt_create`,
       `m`.`gmt_modify`  AS `gmt_modify`,
       `m`.`create_by`   AS `create_by`,
       `m`.`modify_by`   AS `modify_by`,
       `sr`.`CODE`       AS `role_Code`,
       `sr`.`ID`         AS `role_Id`
from ((`sys_module` `m` join `sys_role_module` `r`) join `sys_role` `sr`)
where ((`m`.`ID` = `r`.`MODULE_ID`) and (`r`.`ROLE_ID` = `sr`.`ID`));

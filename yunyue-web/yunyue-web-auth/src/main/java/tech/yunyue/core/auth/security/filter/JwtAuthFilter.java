package tech.yunyue.core.auth.security.filter;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.JakartaServletUtil;
import tech.yunyue.core.auth.util.CacheTokenUtil;
...
//            if (StrUtil.isNotBlank(uid) && SecurityContextHolder.getContext().getAuthentication() == null) {
            if (StrUtil.isNotBlank(account)) {
                logger.debug("tech.yunyue.security context was null, so authorizing user");
                ...
                logger.info("authenticated user " + account + ", setting tech.yunyue.security context");
